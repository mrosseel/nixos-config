...
_G.packer_plugins = {
  ...
  firenvim = {
    loaded = true,
    path = "/Users/mike/.local/share/nvim/site/pack/packer/start/firenvim",
  ...
  ["linediff.vim"] = {
    loaded = true,
    path = "/Users/mike/.local/share/nvim/site/pack/packer/start/linediff.vim",
  ...
  ["vim-tmux-navigator"] = {
    loaded = true,
    path = "/Users/mike/.local/share/nvim/site/pack/packer/start/vim-tmux-navigator",
